 ...
 * @see plugin_api
 */
class IconSetPluginManager extends DefaultPluginManager implements IconSetPluginManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/IconSet', $namespaces, $module_handler, 'Drupal\icon_set\IconSetInterface', 'Drupal\icon_set\Annotation\IconSet');
